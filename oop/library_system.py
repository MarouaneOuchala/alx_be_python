...
class EBook(Book):
    ...
    def __str__(self):
        return f"EBook - Title: {self.title}, Author: {self.author}, File Size: {self.file_size}MB"
...
class PrintBook(Book):
    ...
    def __str__(self):
        return f"PrintBook - Title: {self.title}, Author: {self.author}, Pages: {self.page_count}"
